  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!profileSnap.exists() || profileSnap.data().role !== 'admin') {
        setError('This account is not registered as an admin. Please use the user login if appropriate.');
        return;
      }
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-white shadow-sm">
        <div className="container">
          <Link className="navbar-brand" to="/">
            ...
            <strong className="text-muted">Recharge Plus Admin</strong>
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item">
                <Link className="nav-link text-muted" to="/admin/register">Register</Link>
              </li>
            </ul>
          </div>
        </div>
              ...
              <div className="card border-0 shadow-sm">
                <div className="card-body p-5">
                  ...
                  <div className="text-center mt-3">
                    <Link to="/admin/register">Don't have an admin account? Register here</Link>
                  </div>
                </div>
              </div>
            </div>
